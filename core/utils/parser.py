...
def parser_train():
    ...
    parser.add_argument('-sa', '--start-adv-epochs', type=int, default=0, help='Number of adversarial training epochs.')    
    ...
    parser.add_argument('--MIX', action='store_true', default=False, help='MIX training.')
    parser.add_argument('--CE', action='store_true', default=False, help='CE training.')
    parser.add_argument('--REVER', action='store_true', default=False, help='REVER training.')
