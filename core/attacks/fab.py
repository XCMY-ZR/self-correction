...
class FAB(LabelMixin):
    ...
    """
    def __init__(self, predict, loss_fn='ce', n_restarts=5, eps=0.3, nb_iter=40, ord=np.inf, seed=1):
        ...
        self.fab = FABAttack_PT(predict, n_restarts=n_restarts, n_iter=nb_iter, verbose=False, eps=eps, 
                                 norm=norm,seed=seed, device=device)
